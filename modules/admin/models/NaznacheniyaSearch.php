...
/**
 * NaznacheniyaSearch represents the model behind the search form of `app\modules\admin\models\Naznacheniya`.
 */
class NaznacheniyaSearch extends Naznacheniya
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'naimenivanie', $this->naimenivanie]);
